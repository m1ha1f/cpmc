...
@secton vl-stringop-file-protocols File protocols

::stringop.h defines a few file "protocols" and helps parsing them
from URL-like formatted strings. The supported protocols are:

<table>
<caption>File protocols</caption>
<th><td>Protocol</td><td>Code</td><td>URL prefix</td></th>
...
::stringop.h functions that write a string to a character buffer take
...
string (provided that @c n &geq; 1). Such functions also return the
 ...
 ** supported @ref vl-file-protocols protocols.  If @c protocol is not
 ...
 ** the @c . character not containing it. For instance, the string @c
 ** file.png contains the extension @c .png and the string @c
 ** file.tar.gz contains two extensions (@c .tar and @c .gz).
 **
 ** @sa vl-stringop-err.
 **/
 ...
 ** @return integer =,<,> 0 if @c string1 =,<,> @c string2
 **/
